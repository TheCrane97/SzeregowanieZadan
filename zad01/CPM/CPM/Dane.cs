...
namespace CPM
{
    ...
    class Dane
    {
        ...
        {
            string[] lines = System.IO.File.ReadAllLines(@"D:\Uczelnia\semestr_6\SzeregowanieZadan\zad01\CPM\"+plik);
            ...
            for(int i=0;i<lines.Length;i+=3)
            {
                ...
                Zadanie z = new Zadanie(numerZadania,czasTrwania,0,0,new List<Zadanie>(),new List<Zadanie>());
